            ...
            <form action="../../baglan/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="first-name" name="food_menu_name"  required="required" placeholder="Menü adını giriniz" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  <textarea  class="ckeditor" id="editor1" name="food_menu_description"></textarea>
                </div>
              </div>
...
<div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="first-name" name="food_menu_price"  required="required" placeholder="Menü sıra giriniz"  class="form-control col-md-7 col-xs-12">
                </div>
              </div>
            ...
            <div class="form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Özel Menü<span class="required">*</span>
              </label>
              <div class="col-md-6 col-sm-6 col-xs-12">
